...
public class TabActivity_post extends Activity {
	private static final String LOG = "PostFragement";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tabactivity_post);
		...
		startcity.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent = new Intent(TabActivity_post.this,
						CityActivity.class);
	...
	public class PostTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			MsgController.savemsgFromJson(TabActivity_post.this, msg);
		...
		protected void onPostExecute(final Boolean success) {
			mAuthTask = null;
			if (success) {
				Toast toast = Toast.makeText(TabActivity_post.this, "信息发布成功",
						Toast.LENGTH_LONG);
				toast.show();

			} else {
				Toast toast = Toast.makeText(TabActivity_post.this, "信息发布失败",
						Toast.LENGTH_LONG);
				toast.show();
			}
		}
