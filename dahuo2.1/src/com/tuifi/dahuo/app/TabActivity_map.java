...
public class TabActivity_map extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ApplicationMap app = (ApplicationMap)this.getApplication();
        if (app.mBMapManager == null) {
            app.mBMapManager = new BMapManager(this);
            app.mBMapManager.init(ApplicationMap.strKey,new ApplicationMap.MyGeneralListener());
        }
...
//        mMapView.setSatellite(true);
        ...
        mMapListener = new MKMapViewListener() {
			...
			public void onClickMapPoi(MapPoi mapPoiInfo) {
				...
				if (mapPoiInfo != null){
					...
					Toast.makeText(TabActivity_map.this,title,Toast.LENGTH_SHORT).show();
		...
		mMapView.regMapViewListener(ApplicationMap.getInstance().mBMapManager, mMapListener);
