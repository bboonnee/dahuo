...
public class SpalshActivity extends formActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				getPreferences() ;			
				ApplicationMap.regionList = RegionController.getResionList(getResources());
				provinceList = RegionController.getProvinceRegion(ApplicationMap.regionList);
				if ((autologin)
						&& (!ApplicationMap.currentUser.id.equals(""))) {
					...
					Intent mainIntent = new Intent(SpalshActivity.this,MainZakerActivity.class);
