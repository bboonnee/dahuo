...
<html>
 ...
 <table cellpadding=2 cellspacing=2>
  ...
  <td></td>
	<td><div id="list" >
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div id="div_<?php echo ($vo["INFO_ID"]); ?>" class="result" style='font-weight:normal;<?php if(($key%2) == "1"): ?>background:#ECECFF<?php endif; ?>'><A href="<?php echo U('read?id='.$vo['INFO_ID']);?>"><?php echo ($vo["NAME"]); ?></A> <?php echo ($vo["E_NAME"]); ?> <?php echo ($vo["INPUT_STLYE"]); ?> <?php echo ($vo["INFO_GROUP"]); ?> 
